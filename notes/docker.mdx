...
<HighlightText>Image management</HighlightText>
...
<HighlightText>Container management</HighlightText>
...
<HighlightText>Clean up</HighlightText>
...
<div className="grid not-prose grid-cols-1 md:grid-cols-2 gap-4">
  <CustomImage
    src="/images/notes/docker/copy-1.png"
    width="595"
    height="354"
  />

  <CustomImage
    src="/images/notes/docker/copy-2.png"
    width="595"
    height="354"
  />
</div>
...
# stop and remove container created by docker compose up
docker compose down
...
<HighlightText>Interact</HighlightText>

```bash
docker exec [OPTIONS] CONTAINER COMMAND [ARG...]

# interact with container named postgres-db-1, perform psql with user hehe
docker exec -it postgres-db-1 psql -U hehe
```

- `-i` (interactive):
- `-t` (tty): Allocates a pseudo-terminal for a readable layout.