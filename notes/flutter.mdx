...
|--------------------|---------------------------------------------------|----------------------------------------------|
| `primary`            | The main brand color for high-emphasis UI.        | Main Action Buttons (Submit, Login).         |
| `onPrimary`          | Color for text/icons sitting on primary.          | White text on a blue "Submit" button.        |
| `primaryContainer`   | A less intense version of primary.                | Background of a "Selected" menu item.        |
| `onPrimaryContainer` | Color for text/icons sitting on primaryContainer. | Darker blue text on a light blue background. |

2. Accent & Contrast (Variety)

| Property    | Purpose                                         | Website Equivalent                                  |
|-------------|-------------------------------------------------|-----------------------------------------------------|
| `secondary`   | For less prominent UI components.               | Filter chips, toggle switches, or "Cancel" buttons. |
| `onSecondary` | Color for text/icons sitting on secondary.      | Text inside a secondary chip.                       |
| `tertiary`    | Used for contrasting accents or "neutralizing". | Highlighting a "New" badge or a "Sale" tag.         |
| `onTertiary`  | Color for text/icons sitting on tertiary.       | Text inside that "Sale" tag.                        |

3. Surface & Hierarchy (Backgrounds)

| Property                  | Purpose                                     | Website Equivalent                                   |
| ------------------------- | ------------------------------------------- | ---------------------------------------------------- |
| `surface`                 | The main background of the app screens.     | The white or light grey body of the webpage.         |
| `onSurface`               | The main text color (Highest emphasis).     | The Black body text you mentioned.                   |
| `onSurfaceVariant`        | The secondary text color (Medium emphasis). | The Gray description text you mentioned.             |
| `surfaceContainer`        | Background for cards and elevated areas.    | The white background of a product card.              |
| `surfaceContainerHighest` | Highest elevation layer.                    | Input Field Backgrounds, Search Bars, Modal Dialogs. |
